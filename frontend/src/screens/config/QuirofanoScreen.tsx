...
const QuirofanoScreen: React.FC = () => {
  // --- ESTADOS ---
  ...
  // Datos (State para permitir cambios)
  const [data, setData] = useState<any>([
    { id: 1, codigo: '001', nombre: 'Quirófano 05', sede: 'Sala Azul Mall Plaza', status: 'Habilitado' },
    { id: 2, codigo: '002', nombre: 'Quirófano 06', sede: 'FOCA Valledupar', status: 'Deshabilitado' },
    { id: 3, codigo: '003', nombre: 'Quirófano 01', sede: 'Clínica Central', status: 'Habilitado' },
  ]);

  // Estado del Formulario
  const initialFormState = { id: null, codigo: '', nombre: '', sede: '' };
  ...
  return (
    <div className="space-y-6 h-full flex flex-col font-sans relative" onClick={() => setOpenMenuIndex(null)}>
      ...
      {/* TÍTULO */}
      <h1 className="text-3xl font-bold text-blue-500">Quirófano</h1>
        ...
        <div className="overflow-visible flex-1">
            <table className="w-full text-sm text-left">
                ...
                <tr>
                    ...
                    <th className="px-6 py-4">No. Quirófano</th>
                ...
                {data.map((row, i) => (
                    ...
                    <td className="px-6 py-4 text-slate-500">{row.sede}</td>
            ...
            <div className="relative bg-white w-full max-w-4xl rounded-[28px] px-10 py-12 shadow-xl animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="flex justify-between items-center mb-10">
                    <h2 className="text-center text-3xl font-bold text-blue-500 flex-1">
                        {isEditing ? 'Editar quirófano' : 'Crear quirófano'}
                    </h2>
                    <button 
                        onClick={() => setIsModalOpen(false)}
                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    {/* 2. Campo: No. Quirófano */}
                    <div>
                        <label className="text-sm font-bold text-slate-700 ml-1">No. Quirófano</label>
                        <input 
                            type="text" 
                            name="nombre"
                            value={formData.nombre}
                            onChange={handleInputChange}
                            placeholder="Ej: Quirófano 05"
                            className="mt-2 w-full bg-slate-50 border border-slate-200 rounded-full px-6 py-3 text-slate-600 outline-none focus:ring-2 focus:ring-blue-100 font-medium" 
                        />
                    </div>
                    ...
                    {/* 3. Campo: Sede (Select) */}
                    <div>
                        <label className="text-sm font-bold text-slate-700 ml-1">Sede</label>
                        <div className="relative mt-2">
                            ...
                            >
                                ...
                                <option value="Sala Azul Mall Plaza">Sala Azul Mall Plaza</option>
...
export default QuirofanoScreen;